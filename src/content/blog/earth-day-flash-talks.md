...
1. **Have zero equations and explain the maths in terms of simple ingredients.**
2. **Fill my slides with animated graphs to keep everyone interested.**

You can see one example of my animated graphs below:

<figure>
  <img src="/images/blog/earth-day-flash-talks/flash_talk.gif" alt="An animated graph from the flash talk" />
</figure>

To conclude the talk after some examples of results from my PhD work, I also showed a fun video of a honeybee swimming (yes, they can swim) from [this paper](https://www.pnas.org/doi/10.1073/pnas.1908857116). It links to my research but it was just to catch attention.
